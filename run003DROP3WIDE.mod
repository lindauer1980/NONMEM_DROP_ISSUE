;; 1. Based on: run003
;; 2. Description: DROP and WIDE

;; x1. Author: alindauer
$PROBLEM    DROP 3 variables and WIDE option
...
;-------------------------------------------------------------------------
$DATA      dummyData_noRound.csv IGNORE=@ WIDE
...
NOPRINT ONEHEADER FORMAT=SF11.3 FILE=sdtab003
